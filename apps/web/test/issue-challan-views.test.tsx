...
function stubApi(overrides: Partial<ApiClient> = {}): ApiClient {
  return {
    ...
    listTallyLedgers: vi.fn().mockResolvedValue({
      ledgers: [],
      nextCursor: null,
      totals: {
        ledgerCount: 0,
    ...
    getAmcCycleProposal: vi.fn().mockResolvedValue({ schedules: [] }),
    setScheduleAmcCycle: vi.fn(),
    setMeasurementBookMeasuredQuantities: vi.fn(),
    ...
    getWorkBillingBaseline: vi.fn(),
    uploadBillingBaselineBill: vi.fn(),
    uploadBillingBaselineMeasurement: vi.fn(),
    setBillingBaselineLines: vi.fn(),
    confirmBillingBaselineLine: vi.fn(),
    lockBillingBaseline: vi.fn(),
    deleteBillingBaseline: vi.fn(),
    setWorkDeductions: vi.fn(),
