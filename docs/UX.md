...
coordinator allocation; the intervening numbers belong to the other packs
of this wave and the one before it. § 21 is the retention pack's, merging
alongside this one — the gap above this heading is that allocation, not a
section somebody dropped.
